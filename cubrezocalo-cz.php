...
<html lang="es">
	<head>
  	...
  	<?php include_once("includes/tag_manager_head.inc"); ?>
		...
		<title>Zócalo MDF Blanco Cubrezocalo CZ - Zocalos, molduras y contramarcos de madera.</title>
	</head>
		...
		<section class="container mb-5 mt-5">
			...
			<div class="row">
				...
				<div class="col-lg-6 mb-5 parent-container">
					...
					<a class="transition productos_mini popup-img" href="img/productos/cubrezocalo-cz/cubrezocalo-cz-principal.jpg" title="Cubrezocalo CZ">
						<img id="principal" class="wow fadeInUp img-fluid" src="img/productos/cubrezocalo-cz/cubrezocalo-cz-principal.jpg" alt="cubrezocalo CZ">
					</a>
					...
					<div class="row">
						...
						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Cubrezocalo CZ" href="img/productos/cubrezocalo-cz/cubrezocalo-cz-render.jpg">
								<img id="render" class="wow fadeInRight img-fluid" src="img/productos/cubrezocalo-cz/cubrezocalo-cz-render.jpg" 
								alt="cubrezocalo CZ render">
							</a>
						</div>
