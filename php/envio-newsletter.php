...
// Envio del mail a la tienda
mail('info@moldurama.com.ar', 'Suscripcion Web a Newsletter', $content,"MIME-Version: 1.0\nContent-type: text/html; charset=UTF-8\nFrom: $name < $email >");
mail('terminacionesnacionales@gmail.com', 'Suscripcion Web a Newsletter', $content,"MIME-Version: 1.0\nContent-type: text/html; charset=UTF-8\nFrom: $name < $email >");
