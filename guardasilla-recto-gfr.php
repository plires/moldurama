					...
					<div class="row">
						...
						<div class="col-4 offset-2">
							<a class="transition productos_mini popup-img" title="Guardasilla GFR" href="img/productos/guardasillas-gfr/guardasillas-gfr-perfil.gif">
								<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/guardasillas-gfr/guardasillas-gfr-perfil.gif" 
								alt="Guardasilla GFR perfil">
							</a>
						</div>
						...
						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Guardasilla GFR" href="img/productos/guardasillas-gfr/guardasillas-gfr-render.jpg">
								<img id="render" class="wow fadeInRight img-fluid" src="img/productos/guardasillas-gfr/guardasillas-gfr-render.jpg" 
								alt="Guardasilla GFR render">
							</a>
						</div>
