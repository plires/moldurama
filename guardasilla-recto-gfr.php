...
<head>
	...
	<meta name="description" content="guardasillas GFR. trabajamos zócalos y contramarcos que permiten ahorrar tiempo y dinero ya que vienen listos para colocar.">
	...
	<title>Guardasillas Recto GFR - Zocalos, molduras y contramarcos de madera.</title>
</head>
	...
	<section class="container mb-5 mt-5">
		...
		<div class="row">
			...
			<div class="col-lg-6 mb-5 parent-container">
				...
				<a class="transition productos_mini popup-img" href="img/productos/guardasillas-gfr/guardasillas-gfr-principal.jpg" title="Guardasilla GFR">
					<img id="principal" class="wow fadeInUp img-fluid" src="img/productos/guardasillas-gfr/guardasillas-gfr-principal.jpg" alt="Guardasilla GFR">
				</a>

				<div class="row">

					<div class="col-4 offset-2">
						<a class="transition productos_mini popup-img" title="Guardasilla GFR" href="img/productos/guardasillas-gfr/guardasillas-gfr-perfil.gif">
							<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/guardasillas-gfr/guardasillas-gfr-perfil.gif" alt="Guardasilla GFR perfil">
						</a>
					</div>

					<div class="col-4">
						<a class="transition productos_mini popup-img" title="Guardasilla GFR" href="img/productos/guardasillas-gfr/guardasillas-gfr-render.jpg">
							<img id="render" class="wow fadeInRight img-fluid" src="img/productos/guardasillas-gfr/guardasillas-gfr-render.jpg" alt="Guardasilla GFR render">
						</a>
					</div>
			...
			<div class="productos col-lg-5 offset-lg-1 mb-5">
				<h1 class="wow fadeInUp">GUARDASILLA RECTO MDF</h1>
				<h2 class="wow fadeInLeft">MDF GFR</h2>
