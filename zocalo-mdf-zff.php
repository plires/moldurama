					...
					<div class="row">
						...
						<div class="col-4 offset-2">
							<a class="transition productos_mini popup-img" title="Zocalo ZFF" href="img/productos/zocalo-zff/zocalo-zff-perfil.gif">
								<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zff/zocalo-zff-perfil.gif" 
								alt="zocalo ZFF perfil">
							</a>
						</div>

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Zocalo ZFF" href="img/productos/zocalo-zff/zocalo-zff-render.jpg">
								<img id="render" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zff/zocalo-zff-render.jpg" 
								alt="zocalo ZFF render">
							</a>
						</div>
