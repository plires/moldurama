...
<head>
	...
	<meta name="description" content="Zócalo en mdf blanco zff. trabajamos zócalos y contramarcos que permiten ahorrar tiempo y dinero ya que vienen listos para colocar.">
	...
	<title>Zócalo MDF Blanco ZFF - Zocalos, molduras y contramarcos de madera.</title>
</head>
	...
	<section class="container mb-5 mt-5">
		...
		<div class="row">
			...
			<div class="col-lg-6 mb-5 parent-container">
				...
				<a class="transition productos_mini popup-img" href="img/productos/zocalo-zff/zocalo-zff-principal.jpg" title="Zocalo mdf ZFF">
					<img id="principal" class="wow fadeInUp img-fluid" src="img/productos/zocalo-zff/zocalo-zff-principal.jpg" alt="Zocalo mdf ZFF">
				</a>

				<div class="row">

					<div class="col-4 offset-2">
						<a class="transition productos_mini popup-img" title="Zocalo ZFF" href="img/productos/zocalo-zff/zocalo-zff-perfil.gif">
							<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zff/zocalo-zff-perfil.gif" alt="zocalo ZFF perfil">
						</a>
					</div>

					<div class="col-4">
						<a class="transition productos_mini popup-img" title="Zocalo ZFF" href="img/productos/zocalo-zff/zocalo-zff-render.jpg">
							<img id="render" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zff/zocalo-zff-render.jpg" alt="zocalo ZFF render">
						</a>
					</div>
			...
			<div class="productos col-lg-5 offset-lg-1 mb-5">
				<h1 class="wow fadeInUp">ZÓCALO FANTASÍA MDF</h1>
				<h2 class="wow fadeInLeft">MDF ZFF</h2>
