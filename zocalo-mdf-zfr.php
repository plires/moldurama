...
<head>
	...
	<meta name="description" content="Zócalo en mdf blanco zfr. trabajamos zócalos y contramarcos que permiten ahorrar tiempo y dinero ya que vienen listos para colocar.">
	...
	<title>Zócalo MDF Blanco Curvo ZFR - Zocalos, molduras y contramarcos de madera.</title>
</head>
	...
	<section class="container mb-5 mt-5">
		...
		<div class="row">
			...
			<div class="col-lg-6 mb-5 parent-container">
				...
				<a class="transition productos_mini popup-img" href="img/productos/zocalo-zfr/zocalo-zfr-principal.jpg" title="Zocalo mdf ZFR">
					<img id="principal" class="wow fadeInUp img-fluid" src="img/productos/zocalo-zfr/zocalo-zfr-principal.jpg" alt="Zocalo mdf ZFR">
				</a>
				...
				<div class="row">
					...
					<div class="col-4 offset-2">
						<a class="transition productos_mini popup-img" title="Zocalo ZFR" href="img/productos/zocalo-zfr/zocalo-zfr-perfil.gif">
							<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfr/zocalo-zfr-perfil.gif" alt="zocalo ZFR perfil">
						</a>
					</div>

					<div class="col-4">
						<a class="transition productos_mini popup-img" title="Zocalo ZFR" href="img/productos/zocalo-zfr/zocalo-zfr-render.jpg">
							<img id="render" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfr/zocalo-zfr-render.jpg" alt="zocalo ZFR render">
						</a>
					</div>
