...
<html lang="es">
	<head>
  	...
  	<?php include_once("includes/tag_manager_head.inc"); ?>
		...
		<meta name="description" content="Zócalo moldurado zm34. trabajamos zócalos y contramarcos que permiten ahorrar tiempo y dinero ya que vienen listos para colocar.">
		...
		<title>Zócalo moldurado ZM34 - Zocalos, molduras y contramarcos de madera.</title>
	</head>
		...
		<section class="container mb-5 mt-5">
			...
			<div class="row">
				...
				<div class="col-lg-6 mb-5 parent-container">
					...
					<a class="transition productos_mini popup-img" href="img/productos/zocalo-zm34/zocalo-zm34-principal.jpg" title="Zocalo Moldurado ZM34">
						<img id="principal" class="wow fadeInUp img-fluid" src="img/productos/zocalo-zm34/zocalo-zm34-principal.jpg" alt="zocalo zm34 principal">
					</a>

					<div class="row">

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Zocalo Moldurado ZM34" href="img/productos/zocalo-zm34/zocalo-zm34-perfil.gif">
								<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zm34/zocalo-zm34-perfil.gif" 
								alt="zocalo zm34 perfil">
							</a>
						</div>

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Zocalo Moldurado ZM34" href="img/productos/zocalo-zm34/zocalo-zm34-render.jpg">
								<img id="render" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zm34/zocalo-zm34-render.jpg" 
								alt="zocalo zm34 render">
							</a>
						</div>

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Zocalo Moldurado ZM34" href="img/productos/zocalo-zm34/zocalo-zm34-aplicado.jpg">
								<img id="aplicado" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zm34/zocalo-zm34-aplicado.jpg" 
								alt="zocalo zm34 aplicado">
							</a>
						</div>
				...
				<div class="productos col-lg-5 offset-lg-1 mb-5">
					...
					<h2 class="wow fadeInLeft">Moldurado ZM34</h2>
