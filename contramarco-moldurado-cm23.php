...
<html lang="es">
	<head>
  	...
  	<?php include_once("includes/tag_manager_head.inc"); ?>
		...
		<meta name="description" content="Contramarco moldurado cm23. trabajamos zócalos y contramarcos que permiten ahorrar tiempo y dinero ya que vienen listos para colocar.">
		...
		<title>Contramarco moldurado CM23 - Zocalos, molduras y contramarcos de madera.</title>
	</head>
		...
		<section class="container mb-5 mt-5">
			...
			<div class="row">
				...
				<div class="col-lg-6 mb-5 parent-container">
					...
					<a class="transition productos_mini popup-img" href="img/productos/contramarco-cm23/contramarco-cm23-principal.jpg" title="Contramarco Moldurado CM23">
						<img id="principal" class="wow fadeInUp img-fluid" src="img/productos/contramarco-cm23/contramarco-cm23-principal.jpg" alt="contramarco cm23 principal">
					</a>

					<div class="row">

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Contramarco Moldurado CM23" href="img/productos/contramarco-cm23/contramarco-cm23-perfil.gif">
								<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/contramarco-cm23/contramarco-cm23-perfil.gif" 
								alt="contramarco cm23 perfil">
							</a>
						</div>

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Contramarco Moldurado CM23" href="img/productos/contramarco-cm23/contramarco-cm23-render.jpg">
								<img id="render" class="wow fadeInRight img-fluid" src="img/productos/contramarco-cm23/contramarco-cm23-render.jpg" 
								alt="contramarco cm23 render">
							</a>
						</div>

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Contramarco Moldurado CM23" href="img/productos/contramarco-cm23/contramarco-cm23-aplicado.jpg">
								<img id="aplicado" class="wow fadeInRight img-fluid" src="img/productos/contramarco-cm23/contramarco-cm23-aplicado.jpg" 
								alt="contramarco cm23 aplicado">
							</a>
						</div>
				...
				<div class="productos col-lg-5 offset-lg-1 mb-5">
					...
					<h2 class="wow fadeInLeft">Moldurado CM23</h2>
					<p class="wow fadeInUp">
						<span class="font-weight-bold">Descripción:</span> <br>
						Fabricados en pino Taeda,<br>
						largo de listones 2,50 metros.<br>
					...
					<div class="row">
						...
						<div class="wow fadeInLeft productos_colores col-sm-4 text-center mb-3">
