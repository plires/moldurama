    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 offset-md-2 text-center">
          <h3>LÍNEA ZÓCALOS</h3>
          <p>
            Nuestros zócalos o rodapies son fabricados en MDF y poseen un acabado con pintura a horno de alta
            temperatura, que le brinda excelente vista y gran durabilidad. Estos zócalos permiten resolver los remates
            de piso pared con suma facilidad y son ideales para acompañar pisos flotantes o de madera.
          </p>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 offset-md-2 text-center">
          ...
          <p>Contramarcos fabricados en MDF, son ideales para dar el toque final a cualquier obra, brindan una solución
            estética a las uniones entre marcos y paredes. Poseen acabado con pintura secada a horno de alta
            temperatura, que le brinda excelente vista y gran durabilidad.</p>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 offset-md-2 text-center">
          ...
          <p>
            Los guardasillas de MDF son utilizados principalmente como elementos decorativos y protectores en paredes.
            Estas molduras se colocan en la parte inferior de las paredes para protegerlas de golpes y para darles un
            acabado estético y atractivo.
          </p>
          <p>
            Además de proteger las paredes, los guardasillas de MDF también pueden ocultar imperfecciones en las paredes
            y pueden servir como una transición suave entre diferentes tipos de revestimientos de pared. Por lo tanto,
            los guardasillas de MDF son una excelente opción para darle un toque decorativo a cualquier espacio y al
            mismo tiempo proteger las paredes.
          </p>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 offset-md-2 text-center">
          ...
          <p>
            Al momento de realizar un upgrade en tus ambientes, podés empezar por los detalles. Como por ejemplo cubrir
            los zócalos actuales sin las complicaciones de una obra.
            Otra de las ventajas que ofrecen es que se pueden pintar y de esta forma lograr emparejarlos con la
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 offset-md-2 text-center">
          ...
          <p>
            Todos nuestros productos pueden personalizarse bajo pedido, tanto en sus medidas como colores. <strong>Dejá
