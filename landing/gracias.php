	...
	<section class="gracias container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<img src="img/slide-c.jpg" class="d-block w-100" alt="zocalos en mdf blancos">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<a class="transition" href="https://moldurama.com.ar/contacto.php"><i class="fa fa-envelope" aria-hidden="true"></i>info@moldurama.com.ar</a>
					</div>
					<div class="col-md-12 text-center">
