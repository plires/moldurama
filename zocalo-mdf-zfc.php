				...
				<div class="row">
					...
					<div class="col-4 offset-2">
						<a class="transition productos_mini popup-img" title="Zocalo ZFC" href="img/productos/zocalo-zfc/zocalo-zfc-perfil.jpg">
							<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfc/zocalo-zfc-perfil.jpg" alt="zocalo ZFC perfil">
						</a>
					</div>

					<div class="col-4">
						<a class="transition productos_mini popup-img" title="Zocalo ZFC" href="img/productos/zocalo-zfc/zocalo-zfc-render.jpg">
							<img id="render" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfc/zocalo-zfc-render.jpg" alt="zocalo ZFC render">
						</a>
					</div>
