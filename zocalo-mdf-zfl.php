...
<head>
	...
	<meta name="description" content="Zócalo en mdf blanco zfl. trabajamos zócalos y contramarcos que permiten ahorrar tiempo y dinero ya que vienen listos para colocar.">
	...
	<title>Zócalo MDF Blanco Curvo ZFL - Zocalos, molduras y contramarcos de madera.</title>
</head>
...
<body>
	...
	<section class="container mb-5 mt-5">
		...
		<div class="row">
			...
			<div class="col-lg-6 mb-5 parent-container">
				...
				<a class="transition productos_mini popup-img" href="img/productos/zocalo-zfl/zocalo-zfl-principal.jpg" title="Zocalo mdf ZFL">
					<img id="principal" class="wow fadeInUp img-fluid" src="img/productos/zocalo-zfl/zocalo-zfl-principal.jpg" alt="Zocalo mdf ZFL">
				</a>

				<div class="row">

					<div class="col-4 offset-2">
						<a class="transition productos_mini popup-img" title="Zocalo ZFL" href="img/productos/zocalo-zfl/zocalo-zfl-perfil.gif">
							<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfl/zocalo-zfl-perfil.gif" alt="zocalo ZFL perfil">
						</a>
					</div>

					<div class="col-4">
						<a class="transition productos_mini popup-img" title="Zocalo ZFL" href="img/productos/zocalo-zfl/zocalo-zfl-render.jpg">
							<img id="render" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfl/zocalo-zfl-render.jpg" alt="zocalo ZFL render">
						</a>
					</div>
			...
			<div class="productos col-lg-5 offset-lg-1 mb-5">
				<h1 class="wow fadeInUp">ZÓCALO CURVO MDF</h1>
				<h2 class="wow fadeInLeft">MDF ZFL</h2>
	...
	<!-- Linea Zocalos -->
	<?php include_once('./includes/linea-zocalos.php'); ?>
