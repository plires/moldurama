					...
					<div class="row">
						...
						<div class="col-4 offset-2">
							<a class="transition productos_mini popup-img" title="Zocalo ZFL" href="img/productos/zocalo-zfl/zocalo-zfl-perfil.gif">
								<img id="perfil" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfl/zocalo-zfl-perfil.gif" 
								alt="zocalo ZFL perfil">
							</a>
						</div>

						<div class="col-4">
							<a class="transition productos_mini popup-img" title="Zocalo ZFL" href="img/productos/zocalo-zfl/zocalo-zfl-render.jpg">
								<img id="render" class="wow fadeInRight img-fluid" src="img/productos/zocalo-zfl/zocalo-zfl-render.jpg" 
								alt="zocalo ZFL render">
							</a>
						</div>
